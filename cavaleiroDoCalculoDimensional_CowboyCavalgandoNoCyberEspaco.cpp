...
private:
    ...
    // Paleta Cyberpunk
    const std::vector<std::string> CYBERPUNK_COLORS = {
        "\033[38;2;0;255;255m",   // Cyan neon
        "\033[38;2;255;0;128m",   // Magenta neon  
        "\033[38;2;0;200;100m",   // Verde ácido
        "\033[38;2;255;100;0m",   // Laranja enferrujado
        "\033[38;2;100;0;255m",   // Roxo distópico
        "\033[38;2;0;150;255m",   // Azul ciano frio
        "\033[38;2;255;50;50m",   // Vermelho sangue
        "\033[38;2;150;255;0m"    // Verde neon tóxico
    };
    
    void clearScreen() {
        // \033[H move o cursor para o topo, \033[J limpa o resto. 
        // É mais rápido que o sistema "cls" ou "clear"
...
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠈⠛⠻⠿⢿⣿⣿⣿⣿⣿⣿⣿⡿⠿⠛⠋⠁⠀⠀⠀⠀⠀⠀⠀⠈⠛⠻⠿⠿⠿⠿⠿⠟⠛⠛⠁⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
        ...
        // (Nota: Cole o conteúdo original das suas R"(...)" aqui dentro)
    }
    ...
    void run() {
        ...
        while(true) {
            ...
            // Escolhe uma cor fixa para esta arte baseada no índice
            std::cout << CYBERPUNK_COLORS[artIndex % CYBERPUNK_COLORS.size()];
            std::cout << arts[artIndex];
            resetColor();
            
            std::cout << "\n\n\033[38;2;100;100;100m[ CTRL+C PARA ABORTAR TRANSMISSÃO ]\033[0m";

            // Avança para a próxima arte
            artIndex = (artIndex + 1) % arts.size();

            // VELOCIDADE: 150ms para um efeito rápido de scan
...
int main() {
    // Esconde o cursor para não atrapalhar o visual
    std::cout << "\033[?25l"; 
    
    CyberpunkRenderer renderer;
    renderer.run();
    
    // Mostra o cursor de volta (caso o loop feche)
    std::cout << "\033[?25h"; 
    return 0;
}
